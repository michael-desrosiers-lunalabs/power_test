...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IDLE_STACK_SIZE, 8192);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ISR_STACK_SIZE, 8192);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_TICKS_PER_SEC, 4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_LPTIM_TIMER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_L476RG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_L476RG_STM32L476XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32L476XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_LPTIM_CLOCK_LSI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_LPTIM_CLOCK, 32000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_LPTIM_TIMEBASE, 0xF9FF);
